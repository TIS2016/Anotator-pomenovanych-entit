...
/**
 * Made by: Tomas Mikula
 * Taken from: https://github.com/TomasMikula/Flowless/blob/master/src/main/java/org/fxmisc/flowless/VirtualizedScrollPane.java
 * because org.ape.layout.VirtualizedScrollPane2's horizontal scroll bar in richtextfx-fat-0.7-M3 is bugged in SplitPane.
 */
public class VirtualizedScrollPane2<V extends Node & Virtualized> extends Region implements Virtualized {
    ...
    /**
     * Constructs a org.ape.layout.VirtualizedScrollPane2 with the given content and policies
     */
    public VirtualizedScrollPane2(V content, ScrollPane.ScrollBarPolicy hPolicy, ScrollPane.ScrollBarPolicy vPolicy) {
        ...
        // request org.ape.annotations.org.ape.layout later, because if currently in org.ape.annotations.org.ape.layout, the request is ignored
    ...
    /**
     * Constructs a org.ape.layout.VirtualizedScrollPane2 that only displays its horizontal and vertical scroll bars as needed
     */
    public VirtualizedScrollPane2(V content) {
